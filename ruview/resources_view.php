...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		"`resources`.`Id`" => "Id",
		"`resources`.`Name`" => "Name",
		"concat('<img src=\"', if(`resources`.`Available`, 'checked.gif', 'checkednot.gif'), '\" border=\"0\" />')" => "Available"
	);
	...
	$x->ColCaption = array("Name", "Available");
	$x->ColFieldName = array('Name', 'Available');
