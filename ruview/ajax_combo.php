	...
	$lookups = array(   
		'assignments' => array(   
			...
			'ProjectDuration' => array(
				'parent_table' => 'projects',
				'parent_pk_field' => 'Id',
				'parent_caption' => 'IF(CHAR_LENGTH(if(`projects`.`StartDate`,date_format(`projects`.`StartDate`,\'%d/%m/%Y\'),\'\')) || CHAR_LENGTH(if(`projects`.`EndDate`,date_format(`projects`.`EndDate`,\'%d/%m/%Y\'),\'\')), CONCAT_WS(\'\', if(`projects`.`StartDate`,date_format(`projects`.`StartDate`,\'%d/%m/%Y\'),\'\'), \' <b>to</b> \', if(`projects`.`EndDate`,date_format(`projects`.`EndDate`,\'%d/%m/%Y\'),\'\')), \'\')',
				'parent_from' => '`projects` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'ResourceId' => array(
				...
				'parent_pk_field' => 'Id',
				'parent_caption' => '`resources`.`Name`',
				'parent_from' => '`resources` ',
				'filterers' => array(),
				'custom_query' => 'SELECT `Id`, `Name` FROM `resources` WHERE `Available`=\'1\' ORDER BY 2',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
			)
