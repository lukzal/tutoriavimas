		...
		$pcConfig = array(
			'assignments' => array(   
				'ProjectId' => array(   
					...
					'sortable-fields' => array(0 => '`assignments`.`Id`', 1 => '`assignments`.`ProjectId`', 2 => '`assignments`.`ProjectDuration`', 3 => '`assignments`.`ResourceId`', 4 => '`assignments`.`Commitment`', 5 => '`assignments`.`StartDate`', 6 => '`assignments`.`EndDate`'),
					'records-per-page' => 10,
					'default-sort-by' => 6,
